...
r = remote('socket.cryptohack.org', 13428) #socket.cryptohack.org 13427
...
# Generate the challenge drom the hash function
fiat_shamir_input = str(a).encode()
e = bytes_to_long(sha512(fiat_shamir_input).digest()) % q

# Build a valide response
z = (rnd + e * w) % q
